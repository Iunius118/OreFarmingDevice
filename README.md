...
1. Material slot (材料). Only Cobblestone, Netherrack, or OF C Feeder (丸石・ネザーラック・ＯＦ丙供給装置のみ)
2. Fuel slot (燃料)
3. Product slot (生成物)
...
|:-------------:|:----------------:|:-----------------:|
|   **Major**   |      Stone       |   Nether Brick    |
| **Uncommon**  |     Coal Ore     |                   |
|   **Rare**    |     Iron Ore     | Nether Quartz Ore |
...
| **Uncommon**  |                    Coal Ore                     |                   |
|   **Rare**    |                    Iron Ore                     | Nether Quartz Ore |
| **Very Rare** |                  Redstone Ore                   |  Nether Gold Ore  |
| **Legendary** | Gold Ore, <br>Lapis Lazuli Ore, <br>Diamond Ore |                   |
...
| **Uncommon**  |              Coal Ore              |                   |
|   **Rare**    |              Iron Ore              | Nether Quartz Ore |
| **Very Rare** |     Redstone Ore, <br>Gold Ore     |  Nether Gold Ore  |
| **Legendary** | Lapis Lazuli Ore, <br>Diamond Ore  |                   |
|  **Mythic**   |            Emerald Ore             |  Ancient Debris   |
